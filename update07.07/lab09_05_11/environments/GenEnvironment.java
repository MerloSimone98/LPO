package lab09_05_11.environments;
...
import lab09_05_11.parser.ast.NamedEntity;
...
public class GenEnvironment<T> implements Environment<T> {
	...
	/*
	 * updates the 'info' of the innermost variable 'var', throws an 'EnvironmentException' if no variable 'var' can be
